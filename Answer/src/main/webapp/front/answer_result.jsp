...
<!-- 模式选择 -->
	...
	<style type="text/css">
		div#main div.fancy-select { margin: 0 auto 50px; width:120px;}
...
<!-- 模式选择 -->	
	...
	<!-- arbor.js 结点联系可视化 -->
	<link rel="stylesheet" href="./arbor.js/mxh7kqd-e.css">
	<script type="text/javascript">try{Typekit.load();}catch(e){}</script>
	<style type="text/css">.tk-athelas{font-family:"athelas-1","athelas-2",serif;}</style>
	<script type="text/javascript" src="./arbor.js/mxh7kqd.js"></script>
	<script src="./jquery_js/jquery-2.2.3.min.js"></script>
	<script src="./arbor.js/jquery.address-1.4.min.js"></script>
	<script src="./arbor.js/arbor.js"></script>
	<script src="./arbor.js/arbor-tween.js"></script>
	<script src="./arbor.js/arbor-graphics.js"></script>
	<script src="./arbor.js/semantic_graph.js"></script>
	<script src="./arbor.js/knowledge_graph.js"></script>
	<!-- arbor.js 结点联系可视化 -->
	...
	<!-- 图标1 -->
	<link rel="stylesheet" href="answer_main/answer_main_css/kinerloader2.css"/>
	<!-- 图标1 -->
